...
public enum Product {
	...
	*/
	...
	/**
	 * MasterCard debit card. This implementation includes 18 and 19-digit UK Maestro cards.
	 * @see <a href="http://www.maestrocard.com/uk/">MasterCard Maestro</a>
	 * @see <a href="http://www.barclaycardmerchantservices.co.uk/existing_customers/operational/pdf/binranges.pdf">Card Identification and Validation (January
	 *      2006)</a>
	 */
	MAESTRO(16, 18, 19),
