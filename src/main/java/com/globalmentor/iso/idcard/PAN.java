 ...
 * Numbering system".
 * @see <a href="https://en.wikipedia.org/wiki/ISO/IEC_7812">Wikipedia: ISO/IEC 7812</a>
...
public class PAN implements Comparable<PAN> {
	...
	public String getIndividualAccountIDString() {
		return Integers.toString(getIndividualAccountID(), 10, individualAccountIDLength);
	}
	 ...
	 * @throws SyntaxException if the string is less than {@value #MIN_PAN_LENGTH} in length, one of the components of the account number is not valid, and/or if
	 *           the components do not match the ending check digit.
	 */
	/*TODO fix
	...
	*/
	...
	/**
	 * Account number constructor. This constructor is not reliable if a PAN has an IIN with one or more leading zeros.
	 * @param pan The primary account number value.
	 * @throws ArgumentSyntaxException if the string form of the PAN is less than {@value #MIN_PAN_LENGTH} in length, one of the components of the account number
	 *           is not valid, and/or if the components do not match the ending check digit.
	 */
	 ...
	 * @throws NullPointerException if the given primary account number string is <code>null</code>.
	 * @throws ArgumentSyntaxException if the string is less than {@value #MIN_PAN_LENGTH} in length, one of the components of the account number is not valid,
	 ...
	 * @throws ArgumentSyntaxException if the given individual account identification is more than {@value #MAX_IAD_LENGTH} digits in length and/or is not
	 *           composed solely of Latin digits.
	...
	/**
	 * Determines if this object is equivalent to another object. This method considers another object equivalent if it is another PAN with the same IIN and IAI.
